 ...
 */
int print_pointer(va_list ap, char buff[],
 ...
 * Return: Number of chars printed
 */
int print_non_printable(va_list ap, char buff[],
	int flag, int width, int precision, int size)
{
	int i = 0, offset = 0;
...
int print_reverse(va_list ap, char buff[],
	int flag, int width, int precision, int size)
{
	char *str;
	int i, count = 0;
 ...
 * Return: Numbers of chars printed
 */
int print_rot13string(va_list ap, char buff[],
	int flag, int width, int precision, int size)
{
	char x;
	char *str;
